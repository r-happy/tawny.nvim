...
function M.get(c, _)
  return {
    ...
    BufferLineHintSelected           = { fg = c.teal, bg = c.bg },
    ...
    BufferLineTabSelected            = { fg = c.yellow, bg = c.bg, bold = true },
