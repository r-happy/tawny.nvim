...
function M.get(c, _)
  return {
    ...
    BufferLineCloseButtonSelected    = { fg = c.red_dim, bg = c.yellow },
    BufferLineModified               = { fg = c.orange, bg = c.bg_statusline },
    BufferLineModifiedVisible        = { fg = c.orange, bg = c.bg_statusline },
    BufferLineModifiedSelected       = { fg = c.orange_dim, bg = c.yellow },
