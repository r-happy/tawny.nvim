...
function M.get(c, _)
  return {
    ...
    -- barbecue.nvim
    barbecue_normal            = { fg = c.fg, bg = c.bg_dim },
    ...
    barbecue_context_module    = { fg = c.teal },
    barbecue_context_namespace = { fg = c.teal },
    barbecue_context_package   = { fg = c.orange },
    barbecue_context_class     = { fg = c.teal },
    barbecue_context_method    = { fg = c.blue },
    barbecue_context_property  = { fg = c.fg },
    barbecue_context_field     = { fg = c.fg },
    barbecue_context_constructor = { fg = c.blue },
    barbecue_context_enum      = { fg = c.yellow },
    barbecue_context_interface = { fg = c.teal },
    barbecue_context_function  = { fg = c.blue },
    barbecue_context_variable  = { fg = c.fg },
    barbecue_context_constant  = { fg = c.yellow },
    barbecue_context_string    = { fg = c.green },
    barbecue_context_number    = { fg = c.orange },
    barbecue_context_boolean   = { fg = c.orange },
    barbecue_context_array     = { fg = c.violet },
    barbecue_context_object    = { fg = c.violet },
    barbecue_context_key       = { fg = c.yellow },
    barbecue_context_null      = { fg = c.fg_dim },
    barbecue_context_enum_member = { fg = c.yellow },
    barbecue_context_struct    = { fg = c.teal },
    barbecue_context_event     = { fg = c.orange },
    barbecue_context_operator  = { fg = c.fg },
    barbecue_context_type_parameter = { fg = c.teal },
