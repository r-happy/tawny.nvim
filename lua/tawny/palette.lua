...
M.dark = {
  bg               = hsl(22.5, 10.0, 5.5),
  bg_dim           = hsl(20.0, 9.0, 4.0),
  bg_dark          = hsl(15.0, 8.0, 2.8),
  bg_light         = hsl(24.0, 9.0, 8.5),
  bg_highlight     = hsl(23.1, 9.0, 11.5),
  bg_popup         = hsl(20.0, 9.0, 6.8),
  bg_sidebar       = hsl(20.0, 8.0, 4.6),
  bg_statusline    = hsl(20.0, 8.0, 7.2),

  fg               = hsl(33.7, 30.0, 78.0),
